...

    {
        ...
        children: [
            ...
            // //Employee
            {
                ...
                loadChildren: "./pages/employee-registration/employee-registration.module#EmployeeRegistrationModule"
            },
            {
                path: "employee-working-details",
                loadChildren: "./pages/employee-working-details/employee-working-details.module#EmployeeWorkingDetailsModule"
            },
            //user details
            {
              path: "userdetails",
              loadChildren: "./pages/userdetails/userdetails.module#UserdetailsModule"
            },
            //update
            {
              path: "update",
             ...
             {
              path: "graph",
              loadChildren: "./pages/graph/graph.module#GraphModule"
            },
            //linegraph
            {
              path: "linegraph",
              loadChildren: "./pages/linegraph/linegraph.module#LinegraphModule"
            },

            //linear-graph
            // {
            //     path: "linear-graph",
            //     loadChildren: "./pages/linear-graph/linear-graph.module#LinearGraphModule"
            //   },
            {
                path: "profile",
